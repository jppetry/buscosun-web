...
> Stand: 2026-08-24 (Statusblock: Bandbreiten-Linie **BW-0…BW-5 vollständig umgesetzt** — Feuerwetter/`fireSpread` gelöscht, Wind + Temperatur als PNG über jsDelivr seit BW-4 **default-on**, Regenradar entschlackt (BW-5: RADOLAN-Anteil der DE-Sitzung −89,9 %); `verify:repack` 106/106, neu `verify:radar-runs` 22/22. **Verifier-Zahl 52 npm-Aliase / 55 Harnische** — die früheren „56/57/58" waren fortgeschrieben statt gezählt, s. Abschnitt Verifikation). Davor 2026-08-22 spät (BH1 Brand-Historie; davor RT1 Pfad-Routing; davor TA Thermalanomalien). Davor 2026-08-19 (Statusblock: Aktiv-Feuer AF0–AF4 umgesetzt inkl. Kalibriermodell v1 aus Archivdaten
