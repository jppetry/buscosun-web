...
> **Stand: 2026-09-18 (Abend).** Dieser Block trägt nur den AKTUELLEN Stand. Die Chronik der Phasen bis
...
| AP9 Backtest | **startet parallel** (eigene Session, Kickoff `prompt.md` vom 18.09.) | Sammler → Archiv-Schema 3: Cube-Pfad kompakt (`v2codec`), gekürzter 2×2-Block je Stufe (E-F-19), POI-Wetterspalten (V-FI-76), Options-/calib-Hash; Nachlauf + Scorer (`verify:pv-score --archive`). Gehört AP9: `scripts/punktarchiv/**`, `verify-pv-score.mjs`, §9.13, V-FI-32…39. 0–48 h bewertbar ab jetzt, 30 Fälle je t3-Bin ≈ Ende Oktober |
...
totalJs je AP (E-F-21, AP16: 1 437, AP17: 1 438), `crossChunk` erst nach dem Randbefund; AP15: Gate rot — bestätigen, dass erst AP9 gegen Stationen misst; AP16 ansehen und committen; **AP17-Diff freigeben (E-F-15: Push, dann Kopie der Cron-Vorlage mit `POINT_Z0MOD`) und committen**.
