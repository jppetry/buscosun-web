...
| AP9 Backtest · AP10 Kalibrierung | **nächste Etappen** | AP9 über das Archiv (`verify:pv-score --archive`, Sammler nimmt den Cube-Pfad mit `pointSource: 'cube'`); 0–48 h bewertbar ab jetzt, 336 h ab 30.09., 30 Fälle je t3-Bin ≈ Ende Oktober |
...
(V-FI-11, Live-Produkt)**, V-FI-24-Zeile an AP9, Real-Device mit `?startnow=0&pf=cube&pflog=1`.
